 ...
 with dmConexoes do
    begin
      ...
      qrCliente.First;
            ...
            qrCliente.Insert;
            qrCliente.fieldbyname('NOME').asstring                               := trim(edtnomecliente.text);
            qrCliente.fieldbyname('CPF').asstring                                := trim(edtcpfcliente.text);
            qrCliente.fieldbyname('ENDERECO').asstring                           := trim(edtendereco.text);
